        ...
        return (  
            <div className="card">
                ...
                <div className="form-group">
                  ...
                  <input type="text" name="nombre" onChange={this.cambioValor} id="nombre" value={nombre}
                ...
                <div className="form-group">
                  ...
                  <input type="text" name="correo" onChange={this.cambioValor}  id="correo" value={correo}
